                ...
                <div className={css.bottom_section}>
                    ...
                    <div className={css.bottom_about}>
                        <p className={css.about}>
                            ...
                            января 2015 г.
                            &nbsp;
                            <a className={css.link} href='https://alfabank.ru/make-money/strahovanie_vkladov/'>АО «Альфа-Банк» является участником системы обязательного
                                страхования вкладов.</a>
                            &nbsp;
                            <a className={css.link} href='https://alfabank.ru/about/annual_report/riskinfo/'>Информация о процентных ставках по договорам банковского вклада с
                            ...
                            &nbsp;
                            <a className={css.link} href='https://alfabank.ru/about/shareholders/'>Информация о лицах, под контролем либо значительным влиянием которых
                                находится Банк.</a>
                        ...
                        <p className={css.about}>
                            <a className={css.link} href='https://alfabank.ru/about/personal_politics/'>АО «Альфа-Банк» использует файлы «cookie» с целью персонализации
                                сервисов и повышения удобства
